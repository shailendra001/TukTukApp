...
@objc public protocol SideMenuDelegate {
    @objc optional func sideMenu(_ sideMenu: SideMenu, shouldRecognizeGesture recognizer: UIGestureRecognizer, simultaneouslyWith otherGestureRecognizer: UIGestureRecognizer) -> Bool
    @objc optional func sideMenu(_ sideMenu: SideMenu, gestureRecognizer: UIGestureRecognizer, shouldRequireFailureOf otherGestureRecognizer: UIGestureRecognizer) -> Bool
    @objc optional func sideMenu(_ sideMenu: SideMenu, gestureRecognizer: UIGestureRecognizer, shouldBeRequiredToFailBy otherGestureRecognizer: UIGestureRecognizer) -> Bool
    @objc optional func sideMenu(_ sideMenu: SideMenu, didRecognizePanGesture recognizer: UIPanGestureRecognizer)
    @objc optional func sideMenu(_ sideMenu: SideMenu, willShowMenuViewController menuViewController: UIViewController)
    @objc optional func sideMenu(_ sideMenu: SideMenu, didShowMenuViewController menuViewController: UIViewController)
    @objc optional func sideMenu(_ sideMenu: SideMenu, willHideMenuViewController menuViewController: UIViewController)
    @objc optional func sideMenu(_ sideMenu: SideMenu, didHideMenuViewController menuViewController: UIViewController)
}

@IBDesignable open class SideMenu: UIViewController, UIGestureRecognizerDelegate {
    ...
    public var animationDuration: TimeInterval =  0.30
    ...
    override open func viewDidLoad() {
        ...
        button.addTarget(self, action: #selector(SideMenu.hideMenuViewController), for: .touchUpInside)
...
//            self.contentViewContainer.center = CGPoint(x: (UIInterfaceOrientationIsLandscape(UIApplication.shared.statusBarOrientation) ? self.contentViewInLandscapeOffsetCenterX + self.view.frame.width : self.contentViewInPortraitOffsetCenterX + self.view.frame.width), y: self.contentViewContainer.center.y)
            ...
            self.contentViewContainer.center = CGPoint(x: self.contentViewInPortraitOffsetCenterX + self.view.frame.width, y: self.contentViewContainer.center.y)
            if self.fadeMenuView {
    ...
    func showRightMenuViewController() {
        ...
        UIView.animate(withDuration: self.animationDuration, animations: {
            ...
            self.contentViewContainer.center = CGPoint(x: -self.contentViewInPortraitOffsetCenterX, y: self.contentViewContainer.center.y)
    ...
    override open func willAnimateRotation(to toInterfaceOrientation: UIInterfaceOrientation, duration: TimeInterval) {
        if self.visible {
            ...
            if self.leftMenuVisible {
                ...
                center = CGPoint(x: self.contentViewInPortraitOffsetCenterX + self.view.frame.width, y: self.contentViewContainer.center.y)
            } else {
                ...
                center = CGPoint(x: -self.contentViewInPortraitOffsetCenterX, y: self.contentViewContainer.center.y)
            }
